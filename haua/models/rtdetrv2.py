...
from .head import RTDETRTransformerv2, RTDETRInstanceSegmenter
    ...
    def __init__(
        ...
        module_configs = {
            ...
            "head": {
                ...
                "query_select_method": "default"}} # default, agnostic
        super().__init__(
            Darknet, HybridEncoder, RTDETRInstanceSegmenter, custom_postprocess, module_configs)
